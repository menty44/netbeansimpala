...
- mavenproject2-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- mavenproject2-ui: main application module, development time
- mavenproject2-production: module that produces a production mode WAR for deployment
