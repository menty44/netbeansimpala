            ...
            <div class="right_col" role="main">
                ...
                %>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input id="firstname" name="firstName" class="form-control has-feedback-left" type="text" autocomplete="false"    placeholder="First Name" <%
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                           <input id="input" name="lastName" class="form-control has-feedback-left" type="text"  autocomplete="false"  placeholder="Last Name"<%
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                          <input id="input" name="email" class="form-control has-feedback-left" type="text"  autocomplete="false" placeholder="Email"<%
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                             <input id="input" name="phone" class="form-control has-feedback-left" type="text" autocomplete="false" placeholder="Phone Number" <%
                                      out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("phone")) + "\"");
                                         %> >
                                            <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                              <input id="input" name="username" class="form-control has-feedback-left" type="text"  autocomplete="false" placeholder="Portal Username"<%
                                        out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("username")) + "\"");
                                         %> >
                                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                             <input id="input" name="apiUsername" class="form-control has-feedback-left" type="text"  autocomplete="false" placeholder="Api username"<%
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Portal Password
                                </label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input id="input" name="loginPasswd" class="form-control col-md-7 col-xs-12" type="password"  autocomplete="false"  <%
                                         out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("loginPasswd")) + "\"");
                                         %> >
                                </div>
                             </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Repeat Portal Password
                                </label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input id="input" name="loginPasswd2" class="form-control col-md-7 col-xs-12" type="password"  autocomplete="false"  <%
                                         out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("loginPasswd2")) + "\"");
                                         %> >
                                </div>
                             </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Api Password
                                </label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <input id="input" name="apiPasswd" class="form-control col-md-7 col-xs-12" type="password"  autocomplete="false" <%
                                        out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("apiPasswd")) + "\"");  
                                         %> >
                                </div>
                             </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Repeat Password
                                </label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <input id="input" name="apiPasswd2" class="form-control col-md-7 col-xs-12" type="password"  autocomplete="false"  <%
                                       out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("apiPasswd2")) + "\"");
                                         %> >
                                </div>
                             </div>
                             <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Default Currency
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                   <select name="accounttype" id="input" class="form-control col-md-3 col-xs-12" required>
                                ...
                                <option value="<%=currencycodes%>" ><%=name%></option>
                             ...
                             <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Account Status
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                   <select name="accountStatus" id="input" class="form-control col-md-3 col-xs-12">
                                            <%
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <div align="right">
                                                        <div id="pagination">
                                                             <form name="pageForm" method="post" action="accountsIndex.jsp">                                
					                    ...
					                    <span class="pageInfo">Page 
					                        <span class="pagePosition currentPage"><%= accountPage.getPageNum()%></span> of 
					                        <span class="pagePosition"><%= accountPage.getTotalPage()%></span>
					                    </span>   
					                    <%
                                                        ...
                                                        <tbody>
                                                           <%
                                                            if (accountList != null) {
                                                                ...
                                                                <tr>
                                                                    <td width="5%"><%=accountCount%></td>
                                                                    <td class="center"><%=code.getFirstName()%></td>
                                                                    <td class="center"><%=code.getLastName()%></td>
                                                                    <td class="center"><%=code.getUsername()%></td>
                                                                    <td class="center"><%=code.getEmail()%></td>
                                                                    <td class="center"><%=code.getPhone()%></td>
                                                                    <td class="center"><%=code.getCreationDate()%></td>
                                                                    <td class="center"><%=code.getAccounttype()%></td>
								    <td class="center"><%=code.getAccountStatusUuid()%></td>
                                                                </tr>
                                                                 <%
                                                                    accountCount++;
                                                                }
