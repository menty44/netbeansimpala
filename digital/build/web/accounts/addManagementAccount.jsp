            ...
            <div class="right_col" role="main">
                ...
                %>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input id="accountsName" name="accountName" class="form-control has-feedback-left" type="text" autocomplete="false"    placeholder="Account Name" <%
                                         out.println("value=\"" + StringUtils.trimToEmpty(paramHash.get("accountName")) + "\"");
                                         %> >
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                            <label class="col-md-3 col-sm-3 col-xs-12 control-label">Add Forex
                                                <br>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 col-sm-3 col-xs-12 control-label">Add Reversal
                                                <br>
                                            </label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="radio">
                                       ...
                                       <div class="form-group">
                                            <label class="col-md-3 col-sm-3 col-xs-12 control-label">Add Balance
                                                <br>
                                            </label>
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio"  name="optionbalance" id="optionbalance1" value="true">Yes
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="optionbalance" id="optionbalance2" value="false">No
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-3 col-sm-3 col-xs-12 control-label">Checker
                                                <br>
                                            </label>
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio"  name="optionchecker" id="optionchecker1" value="true">Yes
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="optionchecker" id="optionchecker2" value="false">No
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                  <div align="right">
                                                        <div id="pagination">
                                                             <form name="pageForm" method="post" action="addManagementAccount.jsp">                                
					                    <%                                            if (!manageaccountPage.isFirstPage()) {
					                    %>
					                    ...
					                    <span class="pageInfo">Page 
					                        <span class="pagePosition currentPage"><%= manageaccountPage.getPageNum()%></span> of 
					                        <span class="pagePosition"><%= manageaccountPage.getTotalPage()%></span>
					                    </span>   
					                    <%
					                        if (!manageaccountPage.isLastPage()) {
					                    %>
                                                ...
                                                <div class="small-box">
                                                    ...
                                                    <div class="x_content">
                                                        ...
                                                        <thead>
                                                            ...
                                                            <th>Account Name</th>
                                                            <th>Username</th>
                                                            <th>Can Update Forex?</th>
                                                            <th>Can Update Balance?</th>
                                                            <th>Can Reverse Transaction?</th>
							    <th>Checker?</th>
                                                        ...
                                                        <tbody>
                                                           <%
                                                                ...
                                                                for (ManagementAccount code : manageaccountList) {
                                                                %>

                                                                <tr>
                                                                    <td width="5%"><%=manageaccountCount%></td>
                                                                    <td class="center"><%=code.getAccountName()%></td>
                                                                    <td class="center"><%=code.getUsername()%></td>
                                                                    <td class="center"><%=code.isUpdateforex()%></td>
                                                                    <td class="center"><%=code.isUpdatebalance()%></td>
                                                                    <td class="center"><%=code.isUpdatereversal()%></td>
								    <td class="center"><%=code.isChecker()%></td>
