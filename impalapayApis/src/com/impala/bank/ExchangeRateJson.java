...
public class ExchangeRateJson {
    ...
    public String tumaBank() throws IOException {
        ...
        try {
            ...
            URL url = new URL("https://staging.impalapay.net:8454/xchangeRate");
            //URL url = new URL("https://staging.impalapay.net/balance");
            ...
            String input = "{\n" +
                            "    \"api_username\": \"demo\",\n" +
                            "    \"session_id\": \"4cc98545f96e4a94a3a6640eac04e983\", \n" +   
                            "    \"currency_code\": \"KES\"\n" +
                            "}";
