 ...
 */
public class BeneficiaryNameJson {

    public String tumaBank() throws IOException {

        try {

            URL url = new URL("https://staging.impalapay.net:8454/verifybeneficiary");
            //URL url = new URL("https://staging.impalapay.net/verifybeneficiary");
