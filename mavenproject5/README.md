...
- mavenproject5-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- mavenproject5-ui: main application module, development time
- mavenproject5-production: module that produces a production mode WAR for deployment
