...
- mavenproject3-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- mavenproject3-ui: main application module, development time
- mavenproject3-production: module that produces a production mode WAR for deployment
