                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-desktop"></i> Rates <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="rates.jsp">Invoices</a>
                                        </li>
...
<!--                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Name <span class="required">*</span>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-sm-12">
                                            ...
                                            <script language="javascript">
                                                    ...
                                                    {
                                                    case "ETH":
                                                    window.location="./countries/ethiopia.jsp";
                                                    break;

                                                    case "GHA":
                                                    window.location="./countries/ghana.jsp";
                                                    break;

                                                    case "KEN":
                                                    window.location="./countries/kenya.jsp";
                                                    break;
                                                    
                                                    case "MAL":
                                                    window.location="./countries/malawi.jsp";
                                                    break;

                                                    case "NIG":
                                                    window.location="./countries/niger.jsp";
                                                    break;
                                                    
                                                    case "NGR":
                                                    window.location="./countries/nigeria.jsp";
                                                    break;
                                                    
                                                    case "RWN":
                                                    window.location="./countries/rwanda.jsp";
                                                    break;
                                                    
                                                    case "UGN":
                                                    window.location="./countries/uganda.jsp";
                                                    break;
                                                    
                                                    case "ZWE":
                                                    window.location="./countries/zimbambwe.jsp";
                                                    break;
                                            ...
                                            <center>
                                                <select id="s1" NAME="section" onChange="SelectRedirect();">
                                                    ...
                                                    <option value="RWN">RWANDA</option>
    ...
    <script>var inactivityTime = function () {
    var t;
