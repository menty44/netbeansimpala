...
import session.entities.TransfersFacade;
...
@FacesConverter(value = "transfersConverter")
public class TransfersConverter implements Converter {

    @Inject
    private TransfersFacade ejbFacade;
