...
import session.entities.AccountTypesFacade;
...
@FacesConverter(value = "accountTypesConverter")
public class AccountTypesConverter implements Converter {

    @Inject
    private AccountTypesFacade ejbFacade;
