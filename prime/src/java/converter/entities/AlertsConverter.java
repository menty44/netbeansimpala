...
import session.entities.AlertsFacade;
...
@FacesConverter(value = "alertsConverter")
public class AlertsConverter implements Converter {

    @Inject
    private AlertsFacade ejbFacade;
