...
import session.entities.TicketsFacade;
...
@FacesConverter(value = "ticketsConverter")
public class TicketsConverter implements Converter {

    @Inject
    private TicketsFacade ejbFacade;
