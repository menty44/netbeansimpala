...
import session.entities.MembersFacade;
...
@FacesConverter(value = "membersConverter")
public class MembersConverter implements Converter {

    @Inject
    private MembersFacade ejbFacade;
