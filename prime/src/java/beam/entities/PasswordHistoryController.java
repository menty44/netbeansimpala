...
@Named(value = "passwordHistoryController")
@ViewScoped
public class PasswordHistoryController extends AbstractController<PasswordHistory> {
    ...
    public PasswordHistoryController() {
        // Inform the Abstract parent controller of the concrete PasswordHistory Entity
