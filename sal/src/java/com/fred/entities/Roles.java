...
@NamedQueries({
    ...
    @NamedQuery(name = "Roles.findByRoleno", query = "SELECT r FROM Roles r WHERE r.roleno = :roleno"),
...
public class Roles implements Serializable {
    ...
    public Roles(Integer id, int roleno, String roledescription, String createdAt, String rolename) {
        this.id = id;
        this.roleno = roleno;
    ...
    public String toString() {
        return "com.fred.entities.Roles[ id=" + id + " ]";
    }
